...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1710019140ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecgrid&table=bills">`elecgrid`.`bills`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecgrid&table=payment">`elecgrid`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=customer">`opd`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=viewcart">`opd`.`viewcart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=users">`opd`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=pizza">`opd`.`pizza`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=categories">`opd`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=contactreply">`opd`.`contactreply`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=elecgrid&table=customer">`elecgrid`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=opd&table=contact">`opd`.`contact`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="53683e3e627d246f7273595e4e5a556f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            targetdb="elecgrid" targettable="payment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `payment`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="elecgrid" targettable="bills">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `payment` WHERE `payment`.`pay_id` = 14</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="elecgrid" targettable="bills">
                            <div class="action_content">
